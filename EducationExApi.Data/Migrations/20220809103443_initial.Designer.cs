...
namespace EducationExApi.Data.Migrations
{
    ...
    [Migration("20220809103443_initial")]
            ...
            modelBuilder.Entity("EducationExApi.Data.Model.UsersModel.CredentialsContainer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Login = "admin",
                            Password = "admin",
                            PasswordHash = new byte[] { 205, 174, 150, 137, 81, 55, 197, 124, 93, 80, 46, 108, 244, 41, 178, 37, 177, 201, 241, 238, 82, 147, 64, 81, 78, 35, 173, 179, 64, 253, 210, 163, 107, 144, 59, 119, 230, 110, 28, 122, 13, 160, 174, 66, 222, 82, 41, 102, 116, 206, 210, 213, 12, 189, 142, 35, 178, 145, 235, 129, 207, 140, 22, 55 },
